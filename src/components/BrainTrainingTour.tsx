...
export default function BrainTrainingTour({
  run,
  onComplete
}: {
  run: boolean
  ...
  const steps = useMemo<BrainStepMeta[]>(() => [
    {
      ...
      on: 'top',
      message: 'Play brain games here to boost focus and memory.',
      color: 'blue'
    },
    {
      id: 'progress',
      target: '.brain-progress-chart',
      on: 'left',
      message: 'See your progress over time with these charts.',
      color: 'purple'
    },
    {
      id: 'scores',
      target: '.cognitive-scores',
      on: 'top',
      message: 'Check your latest cognitive scores and improvements.',
      color: 'green'
    },
    {
      id: 'training-challenges',
      target: '.training-challenges',
      on: 'bottom',
      message: 'Join training challenges to stay motivated!',
      color: 'pink'
    }
  ], [])
  ...
  useEffect(() => {
    ...
    const mount = (id: string, meta: BrainStepMeta) => {
